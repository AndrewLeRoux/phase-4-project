...
function Posts({posts, user, tags, favorites, onAddFavorite}) {
  ...
  return (
    ...
    {filteredPosts.map((post) =>{ return <Post key = {post.id} post={post} user= {user} favorites={favorites} onAddFavorite={onAddFavorite}/>})}
    </>
    : 
    <>
