...
# Post.create( name: "chair for sale", image_url: "https://www.ikea.com/us/en/images/products/lerhamn-chair-black-brown-vittaryd-beige__0728160_pe736117_s5.jpg?f=s", description: "really nice chair!", user_id: 2, tag_id: 16)
...
# Post.create( name: "earings for sale", image_url: "https://image.brilliantearth.com/media/product_images/WA/BE3LBT60_white_top.jpg", description: "beautiful earings!", user_id: 2, tag_id: 17)
# Post.create( name: "guitar for sale", image_url: "https://m.media-amazon.com/images/I/6104PlqCAdL._AC_SX679_.jpg", description: "plays great!", user_id: 1, tag_id: 18)
# Post.create( name: "football for sale", image_url: "https://images-na.ssl-images-amazon.com/images/I/81Q7Gt6RInL.__AC_SY300_SX300_QL70_FMwebp_.jpg", description: "barely any use. contact for more details", user_id: 1, tag_id: 19)
# Post.create( name: "play station 4 for sale", image_url: "https://media.gamestop.com/i/gamestop/10114375/Sony-PlayStation-4-500GB-Console-Black?$pdp2x$$&fmt=webp", description: "working and in great condition!", user_id: 1, tag_id: 20)
